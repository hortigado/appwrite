...
class Account extends Service {
  ...
  /// limits](https://appwrite.io/docs/authentication-security#limits).
  ///
  Future<String> createOAuth2Session({required enums.OAuthProvider provider, String? success, String? failure, List<String>? scopes}) async {
    ...
    Uri url = Uri(scheme: endpoint.scheme, host: endpoint.host, port: endpoint.port, path: endpoint.path + apiPath, query: query.join('&'));
